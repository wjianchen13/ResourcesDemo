...
public class NinePatchChunk1 implements Externalizable {
	 ...
	 */
	public static NinePatchChunk1 parse(byte[] data) throws DivLengthException, ChunkNotSerializedException, BufferUnderflowException {
		ByteBuffer byteBuffer = ByteBuffer.wrap(data).order(ByteOrder.nativeOrder());

		NinePatchChunk1 chunk = new NinePatchChunk1();
	 ...
	 */
	public static NinePatchChunk1 createChunkFromRawBitmap(Bitmap bitmap) {
		try {
	...
	public static ImageLoadingResult createChunkFromRawBitmap(Context context, Bitmap bitmap) {
		...
		NinePatchChunk1 chunk = type.createChunk(bitmap);
	 ...
	 */
	public static NinePatchChunk1 createEmptyChunk() {
		NinePatchChunk1 out = new NinePatchChunk1();
	 ...
	 */
	public static void createColorsArrayAndSet(NinePatchChunk1 chunk, int bitmapWidth, int bitmapHeight) {
	 ...
	 */
	public static int[] createColorsArray(NinePatchChunk1 chunk, int bitmapWidth, int bitmapHeight) {
	...
	public void readExternal(ObjectInput input) throws IOException, ClassNotFoundException {
		...
		input.read(bytes);
		try {
			NinePatchChunk1 patch = parse(bytes);
	...
	protected static NinePatchChunk1 createChunkFromRawBitmap(Bitmap bitmap, boolean checkBitmap) throws WrongPaddingException, DivLengthException {
	...
	private static void setupColors(Bitmap bitmap, NinePatchChunk1 out) {
	...
	private static void setupPadding(Bitmap bitmap, NinePatchChunk1 out) throws WrongPaddingException {
	...
	private static void setupStretchableRegions(Bitmap bitmap, NinePatchChunk1 out) throws DivLengthException {
